...
double* get_hist(Mat img_hsv, Point center, int r = 10, int bins = 60, int vec_len = 10){
    ...
    sort(temp, temp+bins, greater<double>());
...
double b_distance(double* hist1, double* hist2, int bins, int vec_len = 10){
    double s = 0;
    for (int i=0; i<vec_len; i++){
