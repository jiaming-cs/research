...
Point2f draw_match_double(Mat& img1,
    ...
    for(unsigned int i = 0; i < good_match_num; ++i)
    {
...
void func(string dataset_name, string index_1, string index_2, int initial_thresshold){

    string folder = "/home/jiaming/Documents/research/dataset/";
    string extention = ".ppm";
    Mat out;

    Ptr<SURF> detector_a = SURF::create(initial_thresshold);
    Ptr<SURF> detector_b = SURF::create(initial_thresshold);
    ...
    detector_a = SURF::create(initial_thresshold);
    detector_b = SURF::create(initial_thresshold);
...
int main(int argc, char const *argv[])
{
    ...
    if (argc != 5){
        cout<< "<dataset name> <index_1> <index_2> <initial threshold>" <<endl;
        exit(1);
    }
    string dataset_name = argv[1];
    string index_1 = argv[2];
    string index_2 = argv[3];
    int initial_threshold = strtol(argv[4], NULL, 10);
    func(dataset_name, index_1, index_2, initial_threshold);
    return 0;
