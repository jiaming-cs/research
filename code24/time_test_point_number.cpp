...
void drawMatch(Mat& img1,
    ...
    //end = clock();
    //cout<<"Time for compute: "<< (end-start) * 1.0 / CLOCKS_PER_SEC <<endl;
    detector->detect(img2, key_points_img2);
    //cout<<"Number of total keypoints: "<<key_points_img1.size()<<endl;
    /*
...
int main(int argc, char const *argv[])
{
    ...
    for (int h = 50 ; h < 1000; h += 50){
        Ptr<SurfFeatureDetector> detector = new SurfFeatureDetector(h);
        //while (i<115)
        //{
        ...
        Mat img1 = imread("/home/jiaming/opencv24/img/test1.png", IMREAD_COLOR);
        Mat img2 = imread("/home/jiaming/opencv24/img/test2.png", IMREAD_COLOR);
